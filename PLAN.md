# Harmonogram i zadania (Backlog)

Lista zadań odzwierciedlająca 7 etapów z briefu projektowego.

## Etap 1: Analiza potrzeb użytkowników
- [x] Zapoznanie się z podstawowymi zasadami UI
- [x] Stworzenie minimum 2 person użytkowników
- [x] Opisanie najważniejszych problemów do rozwiązania
...
- [ ] Przetestowanie na różnych rozdzielczościach
- [ ] Optymalizacja elementów graficznych / drobne poprawki wizualne

## Etap 7: Prezentacja i dokumentacja
- [ ] Opracowanie krótkiej dokumentacji w formie PDF (2-4 strony)
- [ ] Dokumentacja zawiera: opis problemu, persony, przepływ, wnioski z testów, decyzje projektowe
- [ ] Przygotowanie aplikacji do live demo na zajęcia
