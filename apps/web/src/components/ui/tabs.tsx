...
function TabsTrigger({
  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        // Nieaktywny tab w light: text-foreground/70 (#605c53 na surface-alt = 5.5:1, WCAG AA ≥ 4.5:1).
        // /60 dawało 4.08:1 — naruszenie color-contrast (axe serious). Dark używa muted-foreground (4.94:1, OK).
